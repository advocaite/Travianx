<div id="textmenu"><a href="dorf3.php" class="selected ">Overview</a> | <span>Resources</span> | <span>Warehouse</span> | <span>CP</span> | <span>Troops</span></div>
<table cellpadding="1" cellspacing="1" id="overview">
    ...
    foreach($varray as $vil){echo '
		<tr class="'.( ($vdata['capital'] == 1) ? 'hl' : '').'">
			<td class="vil fc"><a href="dorf1.php?newdid='.$vil['wref'].'">'.$vil['name'].'</a></td>
