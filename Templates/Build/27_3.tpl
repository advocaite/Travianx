<body>
    <div id="build" class="gid27">
        ...
        <h1>Treasury <span class="level">Level <?php echo $Account->resarray['f'.$id]; ?></span></h1>
        ...
        <table id="show_artefacts" cellpadding="1" cellspacing="1">
            ...
            while($row = mysql_fetch_array($artefact)){
                ...
                echo '<td class="nam">';
                echo '<a href="build.php?id='.$id.'&t=2">'.$row['name'].'</a><div class="info">Treasury <b>20</b>, Effect <b>Account</b></div>';
                echo '</td>';
