			...
			<table class="troop_details" cellpadding="1" cellspacing="1">
				...
				<tbody class="units">
					...
					<tr>
						...
						<td><img src="img/x.gif" class="unit u31" title="<?php echo U31; ?>" alt="<?php echo U31; ?>"></td>

                        <td><img src="img/x.gif" class="unit u32" title="<?php echo U32; ?>" alt="<?php echo U32; ?>"></td>

                        <td><img src="img/x.gif" class="unit u33" title="<?php echo U33; ?>" alt="<?php echo U33; ?>"></td>

                        <td><img src="img/x.gif" class="unit u34" title="<?php echo U34; ?>" alt="<?php echo U34; ?>"></td>

                        <td><img src="img/x.gif" class="unit u35" title="<?php echo U35; ?>" alt="<?php echo U35; ?>"></td>

                        <td><img src="img/x.gif" class="unit u36" title="<?php echo U36; ?>" alt="<?php echo U36; ?>"></td>

                        <td><img src="img/x.gif" class="unit u37" title="<?php echo U37; ?>" alt="<?php echo U37; ?>"></td>

                        <td><img src="img/x.gif" class="unit u38" title="<?php echo U38; ?>" alt="<?php echo U38; ?>"></td>

                        <td><img src="img/x.gif" class="unit u39" title="<?php echo U39; ?>" alt="<?php echo U39; ?>"></td>

                        <td><img src="img/x.gif" class="unit u40" title="<?php echo U40; ?>" alt="<?php echo U40; ?>"></td>
...
?>
    ...
    <?php } ?>
        ...
        <?php } ?>
			...
			$start = ($att_tribe == 3)? 21 : (($att_tribe == 4)? 31: 41);

			$end = ($att_tribe == 3)? 30 : (($att_tribe == 4)? 40: 50);

			

			$unitspeeds = array(6,5,7,16,14,10,4,3,4,5,7,7,6,9,10,9,4,3,4,5,7,6,17,19,16,13,4,3,4,5,7,7,6,9,10,9,4,3,4,5);
