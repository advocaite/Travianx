...
<table class="troop_details" cellpadding="1" cellspacing="1">
	...
	<tr>
		<td class="column-first large"><img class="unit u12" src="img/x.gif" title="Praetorian" alt="Praetorian"> <input class="text" <?php if ($enforce['u2']<=0) {echo ' disabled="disabled"';}?> name="t2" value="<?php echo $enforce['u2']; ?>" maxlength="6" type="text">
		<?php 
