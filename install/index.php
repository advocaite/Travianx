...
if(file_exists("../GameEngine/config.php")){$_GET['s']=6;} 
?>
...
<body>
	<div class="wrapper">
		...
		<div id="mid">
			<div id="side_navi"><?php include("templates/menu.tpl"); ?></div>
			...
			<?php
				...
				//	$bar->tick();
				//}?>
				<div class="headline"><center><span class="f18 c5">TravianX Installation Script</span></center></div>
				<?php 
				...
				echo"<span class='f18 c5'>ERROR!</span><br />It's not possible to write the config file. Change the permission to '777'. After that, refresh this page!";
					...
					switch($_GET['s']){
						case 0:include("templates/greet.tpl");break;
						case 1:include("templates/config.tpl");break;
						case 2:include("templates/dataform.tpl");break;
						case 3:include("templates/field.tpl");break;
						case 4:include("templates/multihunter.tpl");break;
                        case 5:include("templates/oasis.tpl");break;
						case 6:include("templates/end.tpl");break;
					}
				}?>
...
<div class="copyright">Server running on: <b><font color="red">v6.0.0</font></b></div>
</div>
<div id="cfoot"></div>
</div>
</div>
